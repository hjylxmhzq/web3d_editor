...
class SimplifyModifier {
    ...
    modify(geometry, count, noMerge = false) {
        ...
        for (let vertex of vertices) {
            ...
            const originIdx = vertex.originIdx;
            const v = vertex.position;
            position.push(v.x, v.y, v.z);
            uv.push(originUVs.getX(originIdx), originUVs.getY(originIdx), originUVs.getZ(originIdx));
        ...
        simplifiedGeometry.setAttribute('uv', new Float32BufferAttribute(uv, 3));
